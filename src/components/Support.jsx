  ...
  return (
    <div name="support" className="w-full  mt-24  ">
      ...
      <div className="max-w-[1240px] mx-auto text-white relative">
        <div className="px4 py-12">
          <h2 className="text-3xl pt-8 text-slate-300 uppercase text-center  ">
            Support
          </h2>
          <h3 className="text-5xl font-bold text-opacity-60 text-center">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 relative gap-x-8 gap-y-16 px-4 pt-12 sm:pt-20 text-black">
          <div className="bg-white rounded-xl shadow-2xl">
            <div className="p-8">
              ...
              <h3 className="font-bold text-2xl m-6">Sales</h3>
          ...
          <div className="bg-white rounded-xl shadow-2xl">
            <div className="p-8">
              ...
              <h3 className="font-bold text-2xl m-6">Technical Support</h3>
              <p className="text-gray-600 text-xl ">
                Lorem ipsum dolor sit amet consectetur adipisicing elit. In
                repudiandae veritatis ratione error tenetur, voluptates
                architecto possimus ad! Omnis minima ea quidem quisquam unde
          ...
          <div className="bg-white rounded-xl shadow-2xl">
            <div className="p-8">
              ...
              <h3 className="font-bold text-2xl m-6">Media Inquires</h3>
              <p className="text-gray-600 text-xl ">
                Lorem ipsum dolor sit amet consectetur adipisicing elit. In
                repudiandae veritatis ratione error tenetur, voluptates
                architecto possimus ad! Omnis minima ea quidem quisquam unde
